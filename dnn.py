# -*- coding: utf-8 -*-
"""
Created on Thu Mar 21 10:26:38 2019
...
with open (r"C:\\Users\\yujiaoliang\\Desktop\\three.csv") as csvfile1:
    ...
    for row in csv_reader:
        x.append(row)
with open (r"C:\\Users\\yujiaoliang\\Desktop\\output.csv") as csvfile2:
...
dataset = dataset.batch(256)                   # batch size you will use
...
l1 = tf.layers.dropout(l1,rate=0.0,training = tf_is_training)
output = tf.layers.dense(l1, 128, )                     # output layer
